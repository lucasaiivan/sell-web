...
class ValidationException extends AppException {
  ...
  @override
  String toString() =>
      'ValidationException($code): $message${field != null ? ' (Campo: $field)' : ''}';
}
...
class NetworkException extends AppException {
  ...
  @override
  String toString() =>
      'NetworkException($code): $message${statusCode != null ? ' (Status: $statusCode)' : ''}';
}
...
class DatabaseException extends AppException {
  ...
  @override
  String toString() =>
      'DatabaseException($code): $message${operation != null ? ' (Operación: $operation)' : ''}';
}
...
class AuthException extends AppException {
  ...
  @override
  String toString() =>
      'AuthException($code): $message${authType != null ? ' (Tipo: $authType)' : ''}';
}
...
class FileException extends AppException {
  ...
  @override
  String toString() =>
      'FileException($code): $message${filePath != null ? ' (Archivo: $filePath)' : ''}';
}
...
class TimeoutException extends AppException {
  ...
  @override
  String toString() =>
      'TimeoutException($code): $message${timeoutDuration != null ? ' (Timeout: ${timeoutDuration!.inSeconds}s)' : ''}';
}
...
class NotFoundException extends AppException {
  ...
  @override
  String toString() =>
      'NotFoundException($code): $message${resourceType != null ? ' (Tipo: $resourceType)' : ''}';
}
...
class DeviceException extends AppException {
  ...
  @override
  String toString() =>
      'DeviceException($code): $message${deviceType != null ? ' (Dispositivo: $deviceType)' : ''}';
}
...
class AppExceptions {
  ...
  static ValidationException valueOutOfRange(
          String fieldName, dynamic min, dynamic max) =>
      ValidationException(
  ...
  // Base de datos
  static DatabaseException documentNotFound(String collection, String id) =>
      DatabaseException(
  ...
  static FileException fileTooLarge(String fileName, int maxSize) =>
      FileException(
  ...
  // Lógica de negocio
  static BusinessLogicException insufficientStock(
  ...
  // Genéricos
  static ConfigurationException unknownError([String? details]) =>
