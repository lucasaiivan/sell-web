...
class DatabaseCloudService {
  ...
  static CollectionReference<Map<String, dynamic>> publicProducts({String country = 'ARG'}) => 
  ...
  static CollectionReference<Map<String, dynamic>> brands({String country = 'ARG'}) => 
      _firestore.collection('/APP/$country/MARCAS/');

  /// Reportes de productos
  static CollectionReference<Map<String, dynamic>> productReports({String country = 'ARG'}) => 
      _firestore.collection('/APP/$country/REPORTS');

  /// Backup de productos
  static CollectionReference<Map<String, dynamic>> productsBackup({String country = 'ARG'}) => 
      _firestore.collection('/APP/$country/PRODUCTOS_BACKUP');

  /// Backup de marcas
  static CollectionReference<Map<String, dynamic>> brandsBackup({String country = 'ARG'}) => 
  ...
  static CollectionReference<Map<String, dynamic>> accountCatalogue(String accountId) => 
      _firestore.collection('/ACCOUNTS/$accountId/CATALOGUE/');

  /// Categorías de productos de una cuenta
  static CollectionReference<Map<String, dynamic>> accountCategories(String accountId) => 
      _firestore.collection('/ACCOUNTS/$accountId/CATEGORY/');

  /// Proveedores de una cuenta
  static CollectionReference<Map<String, dynamic>> accountProviders(String accountId) => 
      _firestore.collection('/ACCOUNTS/$accountId/PROVIDER/');

  /// Transacciones/ventas de una cuenta
  static CollectionReference<Map<String, dynamic>> accountTransactions(String accountId) => 
      _firestore.collection('/ACCOUNTS/$accountId/TRANSACTIONS/');

  /// Administradores y usuarios de una cuenta
  static CollectionReference<Map<String, dynamic>> accountUsers(String accountId) => 
  ...
  static CollectionReference<Map<String, dynamic>> accountCashRegisters(String accountId) => 
      _firestore.collection('/ACCOUNTS/$accountId/CASHREGISTERS/');

  /// Historial de arqueos de caja (registros cerrados)
  static CollectionReference<Map<String, dynamic>> accountCashRegisterHistory(String accountId) => 
      _firestore.collection('/ACCOUNTS/$accountId/RECORDS/');

  /// Descripciones fijas para movimientos de caja
  static CollectionReference<Map<String, dynamic>> accountFixedDescriptions(String accountId) => 
  ...
  static CollectionReference<Map<String, dynamic>> userManagedAccounts(String email) => 
  ...
  static Reference accountProfileImage(String accountId) => 
      _storage.ref().child("ACCOUNTS").child(accountId).child("PROFILE").child("imageProfile");

  /// Imagen de producto público
  static Reference publicProductImage(String productId) => 
      _storage.ref().child("APP").child("ARG").child("PRODUCTOS").child(productId);
  ...
  static Future<QuerySnapshot<Map<String, dynamic>>> getActiveCashRegisters(String accountId) => 
      accountCashRegisters(accountId).get();

  /// Stream de cajas registradoras activas
  static Stream<QuerySnapshot<Map<String, dynamic>>> activeCashRegistersStream(String accountId) => 
      accountCashRegisters(accountId).snapshots();

  /// Obtiene el historial de arqueos de caja
  static Future<QuerySnapshot<Map<String, dynamic>>> getCashRegisterHistory(String accountId) => 
      accountCashRegisterHistory(accountId).orderBy('opening', descending: true).get();

  /// Stream del historial de arqueos de caja
  static Stream<QuerySnapshot<Map<String, dynamic>>> cashRegisterHistoryStream(String accountId) => 
      accountCashRegisterHistory(accountId).orderBy('opening', descending: true).snapshots();
  ...
  static Future<QuerySnapshot<Map<String, dynamic>>> getCashRegisterByDays({
    ...
    required int days,
        ...
        .where('opening', isGreaterThan: DateTime.now().subtract(Duration(days: days)))
        .orderBy('opening', descending: true)
        .get();

  /// Obtiene los arqueos de caja entre dos fechas
  static Future<QuerySnapshot<Map<String, dynamic>>> getCashRegisterByDateRange({
    required String accountId,
  ...
  static Future<QuerySnapshot<Map<String, dynamic>>> getTodayCashRegisters(String accountId) => 
      accountCashRegisterHistory(accountId)
        .where('opening', isGreaterThanOrEqualTo: DateTime.now().subtract(const Duration(days: 1)))
        .get();
  ...
  static Future<void> incrementProductFollowers(String productId) => 
      publicProducts().doc(productId).update({"followers": FieldValue.increment(1)});
  ...
  static Future<QuerySnapshot<Map<String, dynamic>>> getFavoriteProducts({int limit = 0}) {
  ...
  static Stream<QuerySnapshot<Map<String, dynamic>>> accountCatalogueStream(String accountId) => 
      accountCatalogue(accountId).orderBy('upgrade', descending: true).snapshots();

  /// Stream de categorías de una cuenta
  static Stream<QuerySnapshot<Map<String, dynamic>>> accountCategoriesStream(String accountId) => 
      accountCategories(accountId).snapshots();

  /// Stream de proveedores de una cuenta
  static Stream<QuerySnapshot<Map<String, dynamic>>> accountProvidersStream(String accountId) => 
      accountProviders(accountId).snapshots();

  /// Stream de transacciones de una cuenta
  static Stream<QuerySnapshot<Map<String, dynamic>>> accountTransactionsStream(String accountId) => 
      accountTransactions(accountId).orderBy("creation", descending: true).snapshots();

  /// Stream de usuarios administradores de una cuenta
  static Stream<QuerySnapshot<Map<String, dynamic>>> accountUsersStream(String accountId) => 
  ...
  static Stream<QuerySnapshot<Map<String, dynamic>>> transactionsFromDateStream({
    required String accountId,
  ...
  static Stream<QuerySnapshot<Map<String, dynamic>>> transactionsByDateRangeStream({
    required String accountId,
  ...
  static Future<QuerySnapshot<Map<String, dynamic>>> getTransactionsByDateRange({
    required String accountId,
    required Timestamp startDate,
    required Timestamp endDate,
  }) => accountTransactions(accountId)
