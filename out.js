...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var $async$goto = 0,
        ...
        promise, t2, response, t3, textPromise, text, t1, options;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = type$.String;
              options = A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["method", "GET", "mode", "cors"], t1, t1));
              t1 = window;
              t1.toString;
              promise = t1.fetch.apply(t1, ["https://localhost:8080/status", options]);
              t1 = promise == null ? A._asObject(promise) : promise;
              t2 = type$.dynamic;
              $async$goto = 2;
              return A._asyncAwait(A.promiseToFuture(t1, t2), $async$main);
            case 2:
              // returning from await.
              response = $async$result;
              t1 = response == null;
              t3 = t1 ? A._asObject(response) : response;
              textPromise = t3.text();
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(textPromise == null ? A._asObject(textPromise) : textPromise, t2), $async$main);
            case 3:
              // returning from await.
              text = $async$result;
              t1 = t1 ? A._asObject(response) : response;
              A.printString("status: " + A.S(t1.status) + ", text: " + A.S(text));
              // implicit return
  ...
  A.LinkedHashMapKeyIterator.prototype = {
    ...
    moveNext$0() {
      ...
      if (cell == null) {
        ...
        _this._current = cell.hashMapCellKey;
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.jsify__convert, A.promiseToFuture_closure, A.promiseToFuture_closure0]);
