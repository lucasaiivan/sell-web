...
class MockCatalogueRepository extends _i1.Mock
  ...
  @override
  _i5.Stream<List<_i18.Mark>> getBrandsStream({String? country = r'ARG'}) =>
      (super.noSuchMethod(
        Invocation.method(
          #getBrandsStream,
          [],
...
class MockAuthRepository extends _i1.Mock implements _i23.AuthRepository {
  ...
  @override
  _i5.Future<_i25.Either<_i26.Failure, void>> leaveBusinessAccount(
    String? accountId,
    String? email,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
          #leaveBusinessAccount,
          [
            accountId,
            email,
          ],
